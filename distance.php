...
function distance($origin, $destination){
  ...
  $url = "https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins={$origin}&destinations={$destinationURL}&key=AIzaSyCYX8pBq5f9-oty0U-BMtPb1GIuK0LLae0";
